...
const kBlueColor = Color(0xFF3888c9);
const kRedColor = Color(0xFFc93838);
...
const kResultUnderweightStyle =
    TextStyle(fontSize: 24, color: kBlueColor, fontWeight: FontWeight.bold);
const kResultNormalTextStyle =
    TextStyle(fontSize: 24, color: kGreenColor, fontWeight: FontWeight.bold);
const kResultOverweightTextStyle =
    TextStyle(fontSize: 24, color: kRedColor, fontWeight: FontWeight.bold);
